...
public final class QueryHelper {
    ...
    private static List<News> extractFeatureFromJson(String articlesJSON) {
        ...
        try {
            ...
            // For each article in the articlesArray, create an {@link News} object
...
//                JSONObject properties = currentArticle.getJSONObject("properties");
                ...
                // Extract the value for the key called "sectioName"
                String section = properties.getString("sectionName");


                // Extract the value for the key called "time"
                String time = "";
                time = properties.getString("webPublicationDate");
...
//                        JSONObject authorObject = tagsArray.getJSONObject(j);
//
//                        if (authorObject.getString("type").equals("contributor")) {
//                            if (authors.equals("")) {
//                                authors = "Author(s): ";
//                                // add author(s)
//                                authors = authors + authorObject.getString("webTitle");
//                            }
//                            else
//                                authors = authors + "," + authorObject.getString("webTitle");
//                        }
//                    }
                ...
                // and references from the JSON response.
                News article = new News(title, url, time, authors, section);
            ...
            Log.e("QueryHelper", "Problem parsing the news JSON results", e);
        }
